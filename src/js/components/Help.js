   ...
   <div className= "modal-background">
    ...
    <div className="modal-container help-modal">
     <div className="modal-inner-container">
      ...
      <p>Om du har för avsikt att skapa en ny grupp/förening som andra personer senare kan ansluta sig till så ska du <span className="important">börja med att skapa en grupp innan du skapar ett användarkonto.</span> Fälten där är relativt självförklarande men följande kan vara värt att förtydliga:
      </p>
      <ul>
       ...
       <li>Maximalt antal bokningar per person innebär precis vad det låter som. Det kan vara bra att inte låta en användare ha fler än exempelvis 10 tider bokade samtidigt.</li>
      </ul>
     ...
     Den första personen som går med i gruppen blir automatiskt superadministratör med möjlighet att redigera gruppens inställningar. <span className="important">Observera att det inte går att radera en skapad grupp från applikationens gränssnitt!</span></p>
    <h3>Skapa en ny användare</h3>
    <p>Ska du gå med i en befintlig grupp går du till "Skapa användare" och följer fältens angivelser. Du behöver ange gruppens ID för att kunna gå med i en grupp. Be adminstratören om de uppgifterna.</p>
    <h3>Logga in</h3>
