 ...
 this.bookedBy = bookedBy;
  ...
  for (var i = 0; i < daysInCal; i++) {
   ...
   /*###########################################
    ...
    ############################################
    ############################################*/
    weekday.times = new Object();
    function addTimes(interval, machines, booked,bookedBy,counter) {
        weekday.times["time" + counter] = new newTime(interval, machines, booked,bookedBy);
    }
